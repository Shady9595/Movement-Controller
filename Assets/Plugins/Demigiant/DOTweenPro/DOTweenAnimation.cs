...
//            }
            ...
            case AnimationType.MoveX:
                tween = ((Transform)target).DOMoveX(endValueV3.x, duration, optionalBool0);
            break;
...
//            if (str == "RectTransform") str = "Transform";
        ...
        void ReEvaluateRelativeTween()
        {
            ...
            else if(animationType == AnimationType.MoveX)
            {
                ((Tweener)tween).ChangeEndValue(tweenGO.transform.position + new Vector3(endValueV3.x, 0.0f, 0.0f), true);
            }
